...
// constants, variables
const { fs, mkdirp, promise, safeSync, safeAsync } = helper;
let logger: Function;
let prettyLogger: Function;
...
class jsoncSafe {
    ...
    static stringify(value: any, optionsOrReplacer?: IStringifyOptions | Replacer, space?: string | number): [Error] | [null, string] {
        const opts = helper.getStringifyOptions(optionsOrReplacer, space);
        try {
     ...
     *  // }
     */
    static beautify(str: string, space: string | number = 2): [Error] | [null, string] {
